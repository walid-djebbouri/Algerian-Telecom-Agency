                ...
                <form action="lue.php" method="post">
                    ...
                    while ($donne = $req->fetch()){
                        $resultat = true ;
                         ...
                         <div class="zone">
                             <input  id="2<?php echo $donne['idz']?>" type="text"  disabled value=<?php echo $donne['nom'] ?>  >
                             <input class="checkbox" type="checkbox" name="vue[]" id="<?php echo $donne['idz']?>" value="<?php echo $donne['idz']?>" >
                             <label id="1<?php echo $donne['idz']?>">Marquer Comme Vue</label>
